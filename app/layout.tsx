...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Servicio profesional de lavado de autos en la comodidad de tu hogar",
  ...
  twitter: {
    ...
    description:
      "Servicio profesional de lavado de autos en la comodidad de tu hogar",
    images: [
      "https://res.cloudinary.com/dfjzdxfop/image/upload/v1743015141/piq1s2ztdrrlrqqghlcu.png",
    ],
  },
};
  ...
  return (
    <html lang="es">
      ...
      >
        ...
        <MaintenanceOverlay isActive={isMaintenanceModeActive()} />
        <Analytics />
        <Toaster />
      </body>
    </html>
