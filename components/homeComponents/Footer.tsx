      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-cloud-light">
              Expertos en el cuidado de tu vehículo, ofreciendo servicios de
              limpieza profesional interior y exterior.
            </p>
            <Image
          ...
          <div className="ml-auto">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://www.instagram.com/rise.and.shine.co" 
                target="_blank" 
                rel="noreferrer" 
                className="text-cloud-light hover:text-white"
        ...
        >
          ...
          >
            ...
            <span className="sr-only">Acceso al panel de administración</span>
          </a>
        </div>
      </div>
    </footer>
