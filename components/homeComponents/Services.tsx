...
export default function Services() {
  return (
    <section id="servicios" className="w-full py-9 md:py-20">
      <div className="flex flex-col items-center px-10">
        <h2 className="section_title">Nuestros Servicios</h2>
        <p className="section_subtitle text-center">
          En Rise & Shine, nos enfocamos en brindarte una experiencia de limpieza
          personalizada para tu vehículo. Nuestros servicios están diseñados para
